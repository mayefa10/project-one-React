  ...
  async function onSubmit(e) {
    ...
    const imgUrls = await Promise.all(
      [...images]
        ...
        !formDataCopy.offer && delete formDataCopy.description;
    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex">
          ...
          active:shadow-lg transition-150 ease-in-out w-full ${type === "rent" ? " bg-white text-black" : "bg-slate-600 text-white"
              }`}
          >
            sell
          </button>
          ...
          shadow-md rounded hover:shadow-lg focus:shadow-lg
          active:shadow-lg transition-150 ease-in-out w-full ${type === "sale" ? " bg-white text-black" : "bg-slate-600 text-white"
              }`}
          >
            rent
          </button>
        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase 
          shadow-md rounded hover:shadow-lg focus:shadow-lg
          active:shadow-lg transition-150 ease-in-out w-full ${!parking ? " bg-white text-black" : "bg-slate-600 text-white"
              }`}
          >
            Yes
          </button>
        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase 
          shadow-md rounded hover:shadow-lg focus:shadow-lg
          active:shadow-lg transition-150 ease-in-out w-full ${!furnished ? " bg-white text-black" : "bg-slate-600 text-white"
              }`}
          >
            yes
          </button>
        ...
        <div className="flex mb-6">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase 
          shadow-md rounded hover:shadow-lg focus:shadow-lg
          active:shadow-lg transition-150 ease-in-out w-full ${!offer ? " bg-white text-black" : "bg-slate-600 text-white"
              }`}
          >
            yes
          </button>
